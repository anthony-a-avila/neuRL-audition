...
Running all cells takes a couple of seconds and rewrites the three PNGs in `figures/`:

| figure | contents |
| --- | --- |
| `fig1_three_cases.png` | naive / trained / reward-withheld responses over 8 seeds (paper's Fig. 1) |
| `fig3_surfaces.png` | prediction error and value as functions of trial and time (paper's Fig. 3) |
